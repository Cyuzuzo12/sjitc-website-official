...
logo = () =>{
  return(
    <Link to="/">
    <img src={logo} alt="sjitc-logo"  height="70"
                   width="80" className="img-fluid"/>
    </Link>
  )
}
        ...
        return ( 
           ...
           <Navbar light expand="md" className="bg-white" >
             <div className="container">
               ...
               <img src={logo} alt="sjitc-logo"  height="70"
                   width="80" className="img-fluid"/>
                   <span className="brand-text font-weight-bold ">SAINT JOSEPH INTERGRATED TECHNICAL COLLEGE</span>
               </NavbarBrand>
              ...
              <span className="purple font-weight-bold">Find Us on:</span>
                ...
                <NavItem>
                <a className="nav-link " href="https://m.facebook.com/Saint-Joseph-Integrated-Technical-College-SJITC-Nyamirambo-642601879173487/" active>
           ...
           {/* =============================================================== */}
           <Navbar light expand="md" className="titlebar-yellow">
           </Navbar>
{/* ====================================================================== */}
           <Navbar light expand="md" className="titlebar-blue">
             <div className="container">
               ...
               <Nav className="mr-auto " navbar>
                ...
                >
                  <DropdownToggle className="font-weight-bold menu text-white "  nav>
                  <i className="fa fa-info-circle"/>ABOUT
                  </DropdownToggle>
                  <DropdownMenu className="bg-dark ">
                    
          <DropdownItem className=" bg-dark "> <Link
                              to="/history"
                              className=" font"
                            > History of SJITC</Link></DropdownItem>
          <DropdownItem divider />
          <DropdownItem className=" bg-dark "><Link
                              to="/mission-vision"
                              className=" font"
                            >Mission & Vision</Link></DropdownItem>
          <DropdownItem divider />
          <DropdownItem className=" bg-dark "><Link
                              to="/administration"
                              className=" font"
                            >Team</Link></DropdownItem>
                  </DropdownMenu>
                </Dropdown>
                   <Dropdown
                  nav  inNavbar
                ...
                >
                  <DropdownToggle className="font-weight-bold menu text-white "  nav>
                  <i className="fa fa-graduation-cap"/>ACADEMICS
                  </DropdownToggle>
          ...
          <DropdownItem className=" bg-dark "><Link
                            ...
                            >Advanced Level(A2)</Link> </DropdownItem>
          <DropdownItem divider />
          <DropdownItem className="text-white bg-dark "> <Link
                              to="/advenced-diploma"
                              className="text-white font"
                            >Advanced Diploma & Diploma</Link></DropdownItem>
          <DropdownItem divider />
          <DropdownItem className="text-white bg-dark "><Link
                              to="/"
                              className="text-white font"
                            >Short Courses</Link></DropdownItem>
                  </DropdownMenu>
                </Dropdown>
                <Dropdown
                  nav  inNavbar
